...
public class WinScreen : MonoBehaviour
{
    ...
    private IEnumerator Title(){
        opacity = 0;
        opacity2 = 0;
        btnTxt1.color = new Color32(255, 255, 255, (byte)opacity2);
        btn1.color = new Color32(255, 255, 255, (byte)opacity2);
        btn2.color = new Color32(255, 255, 255, (byte)opacity2);
        btnTxt2.color = new Color32(255, 255, 255, (byte)opacity2);
        txt.color = new Color32(255, 255, 255, (byte)opacity);
        txt.gameObject.GetComponent<RectTransform>().localPosition = new Vector3(0, 115, 0);
